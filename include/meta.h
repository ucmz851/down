...
#define DOWN_META_MAGIC "DOWN001"
#define DOWN_META_MAGIC_LEN 8
#define INLAY_META_MAGIC "INLAY01"
#define INLAY_META_MAGIC_LEN 8

typedef struct {
    char magic[DOWN_META_MAGIC_LEN]; /* "DOWN001\0" */
...
typedef down_meta_hdr_t inlay_meta_hdr_t;
...
typedef down_meta_t inlay_meta_t;

/* Initialize or load existing memory-mapped .down control file */
...
/* Complete download: sync storage, unmap, and remove .down control file */
